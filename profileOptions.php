...
<body>
    <div class="options-wrapper">
        <div class="lefthand-menu">
            <ul>
                <li>
                    <button class="option-btn" id="change-username">
        ...
        <div class="forms">
            <h3>Select a option on the lefthand menu to update.</h3>
        </div>
    </div>
